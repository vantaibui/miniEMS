    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <UiText variant="caption" tone="secondary">
          Demonstrating all standard typography variants used across the
          application.
        </UiText>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
          <UiText variant="body" tone="default">
            Default Tone
          </UiText>
          <UiText variant="body" tone="secondary">
            Secondary Tone
          </UiText>
          <UiText variant="body" tone="muted">
            Muted Tone
          </UiText>
          <UiText variant="body" tone="danger">
            Danger Tone
          </UiText>
          <UiText variant="body" tone="success">
            Success Tone
          </UiText>
          <UiText variant="body" tone="warning">
            Warning Tone
          </UiText>
          <UiText variant="body" tone="info">
            Info Tone
          </UiText>
        </div>
      </div>
